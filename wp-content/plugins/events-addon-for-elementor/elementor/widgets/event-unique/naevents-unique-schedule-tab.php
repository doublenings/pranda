		...
		$this->start_controls_tabs( 'scn_style' );
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .naeep-tab-links a span' => 'color: {{VALUE}};',
					],
				]
			);
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .naeep-tab-links a' => 'background-color: {{VALUE}};',
					],
				]
			);
			$this->add_control(
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .naeep-tab-links a:hover span.title, {{WRAPPER}} .naeep-tab-links li.active a span.title' => 'color: {{VALUE}};',
					],
				]
			);
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .naeep-tab-links a:hover span' => 'color: {{VALUE}};',
					],
				]
			);
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .naeep-tab-links a:hover, {{WRAPPER}} .naeep-tab-links li.active a' => 'background-color: {{VALUE}};',
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .naeep-tab-links a:hover, {{WRAPPER}} .naeep-tab-links li.active a' => 'border-color: {{VALUE}};',
					],
				]
			);
			$this->end_controls_tab();  // end:Normal tab
		...
		$schedule_groups = !empty( $settings['schedule_groups'] ) ? $settings['schedule_groups'] : '';
			...
			if ( !empty( $schedule_groups ) && is_array( $schedule_groups ) ){
	      	...
	      	foreach ( $schedule_groups as $each_logo ) {
						...
						$date = $date ? '<span>'.esc_html($date).'</span>' : '';

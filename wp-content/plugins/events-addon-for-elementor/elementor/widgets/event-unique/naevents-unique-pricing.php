		...
		$this->start_controls_tabs( 'button_style' );
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .naeep-btn-wrap .naeep-btn' => 'background-color: {{VALUE}};',
					],
				]
			);
			$this->add_group_control(
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .naeep-btn-wrap .naeep-btn:hover' => 'background-color: {{VALUE}};',
					],
				]
			);
			$this->add_group_control(
	...
	*/
	protected function render() {
  	...
  	$tickets_percent = $tickets ? ($tickets*100) : '';
		...
		$output = '<div class="naeep-price-item naeep-item">
	              '.$title.$price.'
